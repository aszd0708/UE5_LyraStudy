...
APawn* ULSEquipmentInstance::GetPawn() const
{
	return Cast<APawn>(GetOuter());
}

void ULSEquipmentInstance::SpawnEquipmentActors(const TArray<FLSEquipmentActorToSpawn>& ActorsToSpawn)
{
	if (APawn* OwningPawn = GetPawn())
	{
		...
		for (const FLSEquipmentActorToSpawn& SpawnInfo : ActorsToSpawn)
		{
...
void ULSEquipmentInstance::DestroyEquipmentActors()
{
...
void ULSEquipmentInstance::OnEquipped()
{
	K2_OnEquipped();
}

void ULSEquipmentInstance::OnUnequipped()
{
	K2_OnUnequipped();
}
