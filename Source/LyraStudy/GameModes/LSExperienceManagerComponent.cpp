...
#include "LSExperienceActionSet.h"
...
void ULSExperienceManagerComponent::OnExperienceLoadComplete()
{
	...
	check(LoadState == ELSExperienceLoadState::Loading);
	check(CurrentExperience);
	...
	{
		LoadState = ELSExperienceLoadState::LoadingGameFeatures;
...
void ULSExperienceManagerComponent::OnGameFeaturePluginLoadComplete(const UE::GameFeatures::FResult& Result)
{
...
void ULSExperienceManagerComponent::OnExperienceFullLoadCompleted()
{
	...
	{
		LoadState = ELSExperienceLoadState::ExecutingActions;
		...
		for (const TObjectPtr<ULSExperienceActionSet>& ActionSet : CurrentExperience->ActionSets)
		{
